    ...
    <div class="cart-modal-overlay">
      <div class="cart-modal-container">
        ...
        <header class="cart-header">
          ...
          <button class="icon-btn delete-btn" @click="showClearConfirm = true" v-if="cartStore.items.length > 0">
        ...
        <main class="cart-body">
          ...
          <div v-else>
            ...
            <hr class="divider" v-if="boiledItems.length > 0 || grilledItems.length > 0" />
        ...
        <div v-if="showClearConfirm" class="confirm-overlay">
          <div class="confirm-box">
            ...
            <h3>ยืนยันล้างตะกร้า?</h3>
            <p>คุณต้องการลบรายการอาหารทั้งหมด<br/>ในตะกร้าใช่หรือไม่?</p>
            <div class="confirm-actions">
              <button class="cancel-btn" @click="showClearConfirm = false">ยกเลิก</button>
              <button class="confirm-btn" @click="executeClearCart">ยืนยันลบ</button>
            </div>
          </div>
        </div>
